...
public class CompoundDatabase {
    ...
    private void createIndexes() {
        ...
        // Drop everything
        compoundsCollection.drop();
        compoundsCollection.dropIndexes();
        fingerprintCountsCollection.drop();
        fingerprintCountsCollection.dropIndexes();
    ...
    private void importCompounds() throws IOException {
        ...
        for (int i = 0; i < reader.getSize(); i++) {
            ...
            ArrayList<Integer> fingerprintstosave = new ArrayList<Integer>();

            // Iterate the fingerprints
            for (IFeature fingerprint : fingerprints.getKeySet()) {

                // Check whether we already encountered the feature.
                ...
                // Add the index of the fingerprint
                ...
                fingerprintstosave.add(fingerprintindex);
                ...
                the_fingerprint.put(FINGERPRINT_PROPERTY, fingerprintindex);
            ...
            compound.put(FINGERPRINTS_PROPERTY, fingerprintstosave.toArray(new Integer[]{}));
